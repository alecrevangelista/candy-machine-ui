...
export const welcomeSettings: WelcomeSettings = {
  ...
  countdownTo: date("25 Jan 2022 00:00:00 EST"),
  //Example date below
...
export const whitelistSettings: WhitelistSettings = {
  ...
  startDate: date("11 Jan 2022 00:00:00 EST"),
  endDate: date("18 Jan 2022 00:00:00 EST"),
  countdown: true,
  //Example date below
  // date('29 2021 00:00:00 GMT')
...
export const publicSaleSettings: PublicSaleSettings = {
  ...
  startDate: date("19 Jan 2022 00:00:00 EST"),
  endDate: undefined,
  countdown: false,
  //Example date below
  // date('29 2021 00:00:00 GMT')
